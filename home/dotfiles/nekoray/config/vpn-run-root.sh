...
start() {
  ...
  "/usr/lib/nekoray/nekobox_core" run -c "/home/korsilyn/.config/nekoray/config/sing-box-vpn.json" --protect-listen-path "/home/korsilyn/.config/nekoray/config/protect" --protect-fwmark 514
}
