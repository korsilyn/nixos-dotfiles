...
in {
  options.modules.style.qt = {
    ...
    kvantum = {
      ...
      kvconfig = mkOption {
        type = str;
        default = "${cfg.kvantum.package}/share/Kvantum/Catppuccin-Mocha-Mauve/Catppuccin-Mocha-Mauve.kvconfig";
        description = ''
      ...
      svg = mkOption {
        type = str;
        default = "${cfg.kvantum.package}/share/Kvantum/Catppuccin-Mocha-Mauve/Catppuccin-Mocha-Mauve.svg";
        description = ''
          Path to the kvantum theme package to be used
    ...
    kdeglobals = {
      package = mkOption {
        type = str;
        default = "${cfg.theme.package}/share/color-schemes/CatppuccinMochaMauve.colors";
